...
const transmissions: Transmission[] = [
    ...
    {
        id: 7,
        signals: [HYDROGEN_LINE, HYDROGEN_LINE + DICTIONARY["STOP"], HYDROGEN_LINE + 1, HYDROGEN_LINE + DICTIONARY["STOP"], HYDROGEN_LINE + 2, HYDROGEN_LINE + DICTIONARY["STOP"], HYDROGEN_LINE + 3, HYDROGEN_LINE + DICTIONARY["STOP"], HYDROGEN_LINE + 4, HYDROGEN_LINE + DICTIONARY["STOP"]],
        signalBasis: "hydrogen",
        expectedAnswer: [HYDROGEN_LINE + 5]
    },
    {
        id: 8,
        signals: [HYDROGEN_LINE, HYDROGEN_LINE + DICTIONARY["STOP"], HYDROGEN_LINE + 2, HYDROGEN_LINE + DICTIONARY["STOP"], HYDROGEN_LINE + 4, HYDROGEN_LINE + DICTIONARY["STOP"]],
        signalBasis: "hydrogen",
        expectedAnswer: [HYDROGEN_LINE + 6]
    },
    {
        id: 9,
        signals: [HYDROGEN_LINE + 6, HYDROGEN_LINE + DICTIONARY["STOP"], HYDROGEN_LINE + 5, HYDROGEN_LINE + DICTIONARY["STOP"], HYDROGEN_LINE + 4, HYDROGEN_LINE + DICTIONARY["STOP"], HYDROGEN_LINE + 3, HYDROGEN_LINE + DICTIONARY["STOP"]],
        signalBasis: "hydrogen",
